...
def main() -> None:
    ...
    log_dir = os.path.join(result_path,"/log/loss{}".format(do_time))
    ...
    for epoch in range(config.max_epochs):
        ...
        avg_loss = total_loss / tr_steps_per_epochs                # 訓練用の平均損失値
        avg_loss1 = total_loss1 / tr_steps_per_epochs
        avg_loss2 = total_loss2 / tr_steps_per_epochs
        avg_loss3 = total_loss3 / tr_steps_per_epochs
        avg_loss4 = total_loss4 / tr_steps_per_epochs

        avg_val_loss = total_val_loss / vl_steps_per_epochs         # 評価用の平均損失値
        avg_val_loss1 = total_val_loss1 / vl_steps_per_epochs 
        avg_val_loss2 = total_val_loss2 / vl_steps_per_epochs 
        avg_val_loss3 = total_val_loss3 / vl_steps_per_epochs 
        avg_val_loss4 = total_val_loss4 / vl_steps_per_epochs 
        ...
        if n%10 == 0:
            print("save log")
            loss_P1 = os.path.join(log_dir,"train1")
            loss_P2 = os.path.join(log_dir,"train2")
            loss_P3 = os.path.join(log_dir,"train3")
            loss_P4 = os.path.join(log_dir,"train4")
            ...
            loss_P1 = os.path.join(log_dir,"valid1")
            loss_P2 = os.path.join(log_dir,"valid2")
            loss_P3 = os.path.join(log_dir,"valid3")
            loss_P4 = os.path.join(log_dir,"valid4")
        ...
        print("Epoch {:3d}/{:3d} loss:{:.10f} ba_loss:{:.7f} dr_loss:{:.7f} vo_loss:{:.7f} oth_loss:{:.7f} ## val_loss:{:.7f} ba_vloss:{:.7f} dr_vloss:{:.7f} vo_vloss:{:.7f} oth_vloss:{:.7f}".format(epoch+1, EPOCHS+plus_epochs, avg_loss, avg_loss1, avg_loss2, avg_loss3, avg_loss4, avg_val_loss, avg_val_loss1, avg_val_loss2, avg_val_loss3, avg_val_loss4))
